...
export const AFFIRMATION_CATEGORIES: AffirmationCategory[] = [
  {
    ...
    affirmations: [
      ...
      { id: 4, category: 'career', text: 'I am a person who takes ownership of outcomes, not just tasks.', icon: 'flag-outline' },
      { id: 5, category: 'career', text: 'I am someone whose work speaks louder than words.', icon: 'megaphone-outline' },
      { id: 6, category: 'career', text: 'I am a builder who ships, iterates, and improves without permission.', icon: 'code-slash-outline' },
  ...
  },
  {
    ...
    icon: 'heart-outline',
    affirmations: [
      { id: 20, category: 'love', text: 'I am someone who gives love without keeping score.', icon: 'heart-outline' },
      ...
      { id: 23, category: 'love', text: 'I am someone who communicates with clarity and without defensiveness.', icon: 'chatbubbles-outline' },
      ...
      { id: 26, category: 'love', text: 'I am a person who builds trust through consistency, not grand gestures.', icon: 'ribbon-outline' },
      { id: 27, category: 'love', text: 'I am someone who chooses relationships that elevate both sides.', icon: 'arrow-up-outline' },
      { id: 28, category: 'love', text: 'I am worthy of deep love and I do not settle for less.', icon: 'star-outline' },
    ],
  },
  {
    id: 'health',
    ...
    affirmations: [
      { id: 29, category: 'health', text: 'I am a person who treats training as non-negotiable, not optional.', icon: 'barbell-outline' },
      { id: 30, category: 'health', text: 'I am someone who fuels my body with intention, not impulse.', icon: 'nutrition-outline' },
      ...
      { id: 36, category: 'health', text: 'I am someone who listens to my body and adjusts without guilt.', icon: 'ear-outline' },
  ...
  },
  {
    ...
    affirmations: [
      { id: 38, category: 'growth', text: 'I am a person who learns fastest by doing, not waiting.', icon: 'rocket-outline' },
      { id: 39, category: 'growth', text: 'I am someone who treats every failure as a data point, not a verdict.', icon: 'analytics-outline' },
      ...
      { id: 45, category: 'growth', text: 'I am building deep expertise, not shallow familiarity.', icon: 'telescope-outline' },
  ...
  },
  {
    ...
    affirmations: [
      ...
      { id: 49, category: 'confidence', text: 'I am a person who does not need external validation to trust my direction.', icon: 'compass-outline' },
      ...
      { id: 54, category: 'confidence', text: 'I am someone who sets boundaries without apology or explanation.', icon: 'stop-circle-outline' },
      { id: 55, category: 'confidence', text: 'I am worthy of the goals I set and capable of reaching them.', icon: 'trophy-outline' },
      { id: 56, category: 'confidence', text: 'I am a person who does not shrink to make others comfortable.', icon: 'resize-outline' },
    ],
  },
];
